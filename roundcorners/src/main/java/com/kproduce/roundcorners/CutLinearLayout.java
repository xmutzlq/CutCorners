...
import com.kproduce.roundcorners.util.CutHelper;
 ...
 * <p>Description：<p>
 */
public class CutLinearLayout extends LinearLayout implements RoundMethodInterface {

    private CutHelper mHelper = new CutHelper();

    public CutLinearLayout(Context context) {
        this(context, null);
    }

    public CutLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public CutLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
